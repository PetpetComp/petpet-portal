...
export const additionalCompetitions: Competition[] = [
  ...
  },
  {
    ...mockCompetitions[0],
    id: "CMP-2026-0005",
    name: "Agility Checkpoint Time Trial",
    type: "Checkpoint Time Trial",
    lanes: undefined,
    cutoff: 90,
    checkpoints: 4,
  },
      ...
      : [
          {
            ...
            priceCategory: "Online" as const,
            registrationFee: competition.onlinePrice,
            registrationDate: "2026-08-01T09:00:00Z",
            paymentDate: "2026-08-01T09:10:00Z",
            paymentBy: "admin.petpet",
            paymentMethod: "Bank Transfer",
            paymentVerificationDate: "2026-08-01T15:00:00Z",
            paymentVerifiedBy: "admin.petpet",
            createdDate: "2026-08-01T09:00:00Z",
            createdBy: "admin.petpet",
            updatedDate: "2026-08-01T15:00:00Z",
